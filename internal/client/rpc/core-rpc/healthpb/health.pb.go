...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\x06api.v1\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2B\n" +
	"\rHealthService\x121\n" +
	"\x04Ping\x12\x13.api.v1.PingRequest\x1a\x14.api.v1.PingResponseB@Z>backend/gateway/internal/client/rpc/core-rpc/healthpb;healthpbb\x06proto3"
...
var file_health_proto_depIdxs = []int32{
	0, // 0: api.v1.HealthService.Ping:input_type -> api.v1.PingRequest
	1, // 1: api.v1.HealthService.Ping:output_type -> api.v1.PingResponse
