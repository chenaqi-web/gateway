...
const file_user_proto_rawDesc = "" +
	...
	"\tLoginResp29\n" +
	"\vUserService\x12*\n" +
	"\x05Login\x12\x0e.user.LoginReq\x1a\x0f.user.LoginResp\"\x00B<Z:backend/gateway/internal/client/rpc/core-rpc/userpb;userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 1: user.UserService.Login:output_type -> user.LoginResp
